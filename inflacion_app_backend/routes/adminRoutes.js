...
import { createUserSchema, updateUserPasswordSchema, createPeriodSchema, updatePriceSchema } from '../validators/adminValidators.js';
...
router.post('/periods', validate(createPeriodSchema), adminController.createPeriod);
...
router.put('/prices/:id', validate(updatePriceSchema), adminController.updatePrice);
...
router.put('/users/:userId/password', validate(updateUserPasswordSchema), adminController.updateUserPassword);
